        ...
        <div v-if="metadata" class="w-full px-4 md:px-8 lg:px-16">
            ...
            <div class="relative">
                ...
                <div class="absolute z-20 -top-24 left-64">
                    ...
                    <div
                        class="flex items-center gap-2 mt-2 text-xl text-white"
                    >
                ...
                <div class="w-full shadow-xl card bg-base-100">
                    ...
                    <div
                        class="absolute z-20 flex flex-col items-end gap-2 -top-6 right-8"
                    >
                        <AluButton
                            @click="
                                downloadGame(
                    ...
                    <div class="pt-8 card-body">
                        ...
                        <div class="w-full pl-64 mb-6">
                            ...
                            >
                                <div class="stat" id="nutrition-titleid">
                                    <div
                                        class="stat-title text-base-content/70"
                                    >
                                        Title ID
                                    </div>
                                    <div
                                        class="font-mono text-lg stat-value text-base-content"
                                    >
                                        {{ metadata.titleId }}
                                    </div>
                                </div>
                                <div class="stat" id="nutrition-release-date">
                                    ...
                                    <div
                                        class="text-lg stat-value text-base-content"
                                    >
                                        {{
                                            dateFromYYYYMMDD(
                        ...
                        >
                            <div class="relative">
                                ...
                                <div
                                    class="flex justify-center w-full gap-2 py-2 mt-2"
                                >
                            ...
                            >
                                <div
                                    class="relative max-w-5xl max-h-screen p-4"
                                >
                                    <img
                                        :src="fullScreenImage"
                                    ...
                                    />
                                    <button
                                        class="absolute top-4 right-4 btn btn-circle btn-sm"
                            ...
                            <div class="grid gap-4 md:grid-cols-3">
                                ...
                                >
                                    ...
                                    <div
                                        class="stat"
                                        v-if="
                                            metadata.ratingContent &&
                                            metadata.ratingContent.length
                                        "
                                    >
                                        <div
                                            class="stat-title text-base-content/70"
