                                ...
                                <div class="stat" id="nutrition-categories">
                                    ...
                                    <div class="text-lg stat-value">
                                        <div class="flex flex-wrap gap-1">
                                            <div v-for="(
category, index
                                                ) in metadata.category" :key="index"
                                ...
                                <div class="w-full overflow-hidden rounded-lg shadow-lg carousel">
                                    <div class="flex w-full carousel-item">
                                        <div class="grid w-full grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                                            <div v-for="(
screenshot, index
                                                ) in visibleScreenshots" :key="index"
                                    ...
                                    ">
                                        ...
                                        <div class="text-lg stat-value">
                                            <div class="flex flex-wrap gap-1">
                                                <div v-for="(
warning, i
                                                    ) in metadata.ratingContent" :key="i"
    ...
    async created() {
        ...
        if (this.titleId) {
            try {
                ...
                this.metadata = await TitleMetadata.fetchMetaViewById(this.titleId);
