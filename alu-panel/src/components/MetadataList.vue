<template>
  ...
  <div
    v-if="metadata"
    class="fixed inset-0 h-screen bg-center bg-no-repeat bg-cover brightness-50 blur-xl opacity-70"
    ...
    <div v-if="metadata" class="w-full px-4 md:px-8 lg:px-16">
      ...
      <div class="relative">
        ...
        <div class="w-full shadow-xl card bg-base-100">
          ...
          <div
            class="flex flex-col items-end gap-2 p-4 lg:absolute lg:z-20 lg:-top-6 lg:right-8"
          >
            <AluButton
              @click="downloadGame(selectedDownloadId || metadata.titleId)"
              level="success"
              size="medium"
              class="shadow-lg shadow-success/10"
              style="width: 100%"
            >
          ...
          <div class="pt-8 card-body">
            ...
            <div :class="{ 'pl-64': isDesktop, 'w-full': true, 'mb-6': true }">
              <div
                class="max-w-3xl shadow stats stats-vertical lg:stats-horizontal bg-base-300"
              >
                ...
                <div class="stat" id="nutrition-categories">
                  ...
                  <div class="text-lg stat-value">
                    <div class="flex flex-wrap gap-1">
                      <div
                        v-for="(category, index) in metadata.category"
                        :key="index"
            ...
            <div
              v-if="metadata.screenshots && metadata.screenshots.length > 0"
              class="w-full mb-8"
            >
              <div class="relative">
                <div
                  class="w-full overflow-hidden rounded-lg shadow-lg carousel"
                ...
                <div class="flex justify-center w-full gap-2 py-2 mt-2">
                  ...
                  <span class="text-sm opacity-75 ml-2">
                    ...
                    {{ currentSetIndex * imagesPerSet + 1 }}-{{
                      Math.min(
                        currentSetIndex * imagesPerSet + imagesPerSet,
              ...
              >
                <div class="relative max-w-5xl p-4 flex flex-col items-center">
                  ...
                  <div class="relative image-container">
                    ...
                    >
                      <button
                        @click.stop="navigateFullscreenImage('prev')"
                        class="btn btn-circle bg-base-300/30 hover:bg-base-300/60 ml-4"
                      >
                        ❮
                      </button>
                      <button
                        @click.stop="navigateFullscreenImage('next')"
            ...
            <div
              id="intro"
              class="my-4"
              v-if="metadata.intro && metadata.intro.trim()"
            >
              <blockquote
            ...
            <div class="pt-4" id="extra-info-container">
              ...
              <div class="grid gap-4 md:grid-cols-3">
                <!-- Players -->
                <div
                  class="shadow stats stats-vertical bg-base-300"
                  v-if="metadata.numberOfPlayers"
                >
                  <div class="stat">
                ...
                >
                  <div class="stat">
                    ...
                    <div class="text-lg stat-value">
                      <div class="flex flex-wrap gap-1">
                        <div
                          v-for="(language, i) in metadata.languages"
                          :key="i"
                ...
                <div class="shadow stats stats-vertical bg-base-300">
                  ...
                  <div
                    class="stat"
                    v-if="
                      metadata.ratingContent && metadata.ratingContent.length
                    "
                  >
                    <div class="stat-title text-base-content/70">
                      Content Warnings
                    ...
                    <div class="text-lg stat-value">
                      <div class="flex flex-wrap gap-1">
                        <div
                          v-for="(warning, i) in metadata.ratingContent"
                          :key="i"
  ...
  methods: {
    ...
    async downloadGame(downloadId) {
      try {
        ...
        this.showError(
          "Error downloading game: " + error.message || "Unknown error",
        );
      }
    },
    ...
    async fetchDownloadIds(titleId) {
      try {
        ...
        this.showError(
          `Error fetching download IDs: ${error.message || "Unknown error"}`,
        );
        this.downloadIds = [];
        return [];
      }
    ...
    getCurrentImageIndex() {
      ...
      return this.metadata.screenshots.findIndex(
        (url) => url === this.fullScreenImage,
      );
    },

    // Handle navigation in fullscreen mode
    navigateFullscreenImage(direction) {
      if (!this.metadata || !this.metadata.screenshots || !this.fullScreenImage)
        return;
      ...
      if (direction === "next") {
        ...
        newIndex =
          (currentIndex - 1 + this.metadata.screenshots.length) %
          this.metadata.screenshots.length;
      }
    ...
    async loadMetadata(titleId) {
      ...
      try {
        ...
        this.metadata = null;
        this.showError(
          `Failed to load game data: ${error.message || "Unknown error"}`,
        );
      } finally {
