    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="max-w-4xl mx-auto p-6 space-y-6">
            <div class="bg-gray-800 rounded-lg shadow-md p-6">
                ...
                <form @submit.prevent="createUser" class="flex flex-col md:flex-row gap-4">
                    ...
                    <select v-model="selectedScope"
                        class="w-full max-w-xs select select-bordered bg-gray-700 text-white">
            ...
            <div class="bg-gray-800 rounded-lg shadow-md p-6">
                ...
                <ul class="divide-y divide-gray-600">
                    <li v-for="user in users" :key="user.username" class="py-4 px-2 flex justify-between items-center">
                        <div class="flex items-center gap-2">
                            <span class="text-white font-medium">{{ user.username }}</span>
                            <div class="flex gap-1">
                                <span v-for="scope in user.scopes" :key="scope" class="badge" :class="{
                        ...
                        <AluButton @click="deleteUser(user.username)" size="small" level="danger">
                            Delete
                        </AluButton>
                    </li>
                </ul>
